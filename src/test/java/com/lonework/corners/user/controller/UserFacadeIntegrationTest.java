...
class UserFacadeIntegrationTest extends FacadeIntegrationTestSupport {
    ...
    void getUserListReturnsPersistedUsers() {
        ...
        List<UserListResponse> users = userFacade.getUserList(new UserSearchParameters(null, null, null, null), createPagingQueryParams()).data.stream()
    ...
    void getUserListFiltersUsersBySearchText() {
        ...
        UserSearchParameters userSearchParameters = new UserSearchParameters("ann", null, null, null);
    ...
    void getUserListUsesPageNumberAsOffsetMultiplier() {
        ...
        var result = userFacade.getUserList(new UserSearchParameters(null, null, null, null), new PagingQueryParams(1, 2, null, null));
